...
DOMAIN="sonarqube.boubamahir.com"
CONFIG_FILE="/etc/nginx/sites-available/$DOMAIN"

# Create Nginx configuration file
sudo tee "$CONFIG_FILE" > /dev/null <<'EOL'
upstream sonarqube{
    server sonarqube.boubamahir.com:9000;
}
...
# sudo ln -s "/etc/nginx/sites-available/sonarqube.boubamahir.com" "/etc/nginx/sites-enabled/"
